...
## GitHub и PullRequest

1. Для клонирования репозитория используется команда Git clone

2. Для "вытягивания" изменений - Git pull

3. Для отправки изменений - Git push